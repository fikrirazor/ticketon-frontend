...
const ALL_CITIES = [
  'Jakarta', 'Bandung', 'Bali', 'Surabaya', 'Yogyakarta', 'Medan',
  'Semarang', 'Makassar', 'Palembang', 'Tangerang', 'Depok', 'Bekasi',
  'Bogor', 'Malang', 'Padang', 'Denpasar', 'Samarinda', 'Banjarmasin',
  'Batam', 'Pekanbaru', 'Manado', 'Balikpapan', 'Pontianak', 'Jambi',
  'Cirebon', 'Sukabumi', 'Mataram', 'Serang', 'Tasikmalaya', 'Bandar Lampung',
  'Cilegon', 'Kupang', 'Ambon', 'Jayapura', 'Solo', 'Magelang', 'Purwokerto',
  'Tegal', 'Pekalongan', 'Kudus', 'Cilacap', 'Madiun', 'Kediri', 'Blitar',
  'Probolinggo', 'Pasuruan', 'Mojokerto', 'Jember', 'Banyuwangi', 'Sidoarjo'
].sort();
...
export const FilterPanel = () => {
  ...
  const popularLocations = ['All', 'Jakarta', 'Bandung', 'Bali', 'Surabaya', 'Yogyakarta', 'Medan'];
