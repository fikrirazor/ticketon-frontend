      ...
      {!isLoading && events.length === 0 && (
        <div className="text-center p-8 bg-white rounded-xl border border-gray-100">
          <p className="text-gray-500">
            No events found.{" "}
            <Link to="/create-event" className="text-primary font-semibold">
              Create one
            </Link>
          </p>
        </div>
                  ...
                  <tr key={event.id} className="hover:bg-gray-50/50">
                    ...
                    <td className="px-6 py-4">
                      {editingId === event.id ? (
                        ...
                        <span
                          className={`font-semibold ${event.price === 0 ? "text-green-600" : "text-gray-900"}`}
                        >
                    ...
                    <td className="px-6 py-4">
                      {editingId === event.id ? (
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => startEditing(event.id, event.price)}
                        >
                          Edit Price
                        </Button>
                      )}
