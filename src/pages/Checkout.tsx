  ...
  const handleCheckoutSubmit = async (data: CheckoutData) => {
    ...
    try {
      ...
      console.error("Checkout error details:", {
        ...
        errors: errResponse.response?.data?.errors,
        fullData: errResponse.response?.data,
        requestData: {
          eventId: event.id,
          pointsUsed: data.usePoints ? availablePoints : 0,
          voucherId: data.voucherId,
      ...
      if (
        ...
        const validationErrors = errResponse.response.data.errors
          .map((e) => {
          ...
          <div className="flex-1 space-y-8">
            <header className="space-y-2">
              ...
              <p className="text-slate-500 font-medium">
                Complete your ticket booking details
              </p>
            </header>
                ...
                <p className="text-slate-600 font-medium flex items-center">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M17.657 16.657L13.414 20.828a2 2 0 01-2.828 0L6.343 16.657a8 8 0 1111.314 0z"
                    />
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="sticky top-24 space-y-6">
              {event && (
                <PriceSummary
                  ...
                  pointsDiscount={
                    checkoutValues.usePoints ? availablePoints : 0
                  }
                  voucherDiscount={
                    checkoutValues.discountPercent
                      ? (event.price *
                          checkoutValues.quantity *
                          checkoutValues.discountPercent) /
                        100
                      : 0
                  }
              ...
              <div className="p-6 bg-slate-900 rounded-2xl text-white">
                ...
                <p className="text-sm text-slate-400">
                  Your transaction is encrypted and secured by TicketOn. No
