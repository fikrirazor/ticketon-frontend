...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    description:
      "Experience the most electrifying music festival of the year with top artists from around the globe.",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1459749411177-287ce3288789?auto=format&fit=crop&q=80&w=1000",
  },
  {
    id: "2",
    title: "Tech Innovators Summit 2024",
    description:
      "Join industry leaders and innovators to discuss the future of technology and AI.",
  ...
  },
  {
    ...
    description:
      "An exclusive viewing of contemporary art pieces from emerging local artists.",
    ...
    organizer: {
      id: "3",
      name: "Canvas House",
      email: "gallery@canvashouse.com",
    },
    imageUrl:
      "https://images.unsplash.com/photo-1544928147-79a2af1f98d9?auto=format&fit=crop&q=80&w=1000",
  },
  {
    id: "4",
    title: "Startup Growth Bootcamp",
    description:
      "Intensive workshop for startup founders looking to scale their business.",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1552674605-46d526758ad9?auto=format&fit=crop&q=80&w=1000",
  },
  {
    id: "6",
    title: "Jazz Cafe Night",
    description:
      "Relaxing evening with soulful jazz performances and fine dining.",
...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Amazing festival! The sound quality was top-notch and the atmosphere was electric.",
