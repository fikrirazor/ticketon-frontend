...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    seatLeft: 120,
    category: 'Music',
    organizer: { id: '1', name: 'Lumina Productions', email: 'contact@lumina.com' },
  ...
  },
  {
    ...
    location: 'Bandung',
    address: 'Dago Tea House, Bandung',
    price: 300000,
    seatTotal: 200,
    seatLeft: 45,
    category: 'Technology',
    organizer: { id: '2', name: 'TechForward', email: 'info@techforward.com' },
  ...
  },
  {
    ...
    startDate: '2024-03-20T19:00:00',
    endDate: '2024-03-20T22:00:00',
    location: 'Bali',
    address: 'Ubud Art District, Gianyar',
    price: 75000,
    seatTotal: 100,
    seatLeft: 15,
    category: 'Art',
    organizer: { id: '3', name: 'Canvas House', email: 'gallery@canvashouse.com' },
  ...
  },
  {
    ...
    location: 'Jakarta',
    address: 'SCBD District 8, Jakarta Selatan',
    price: 500000,
    seatTotal: 50,
    seatLeft: 5,
    category: 'Business',
    organizer: { id: '4', name: 'Growth Hackers', email: 'hello@growthhackers.com' },
  ...
  },
  {
    ...
    startDate: '2024-06-02T05:30:00',
    endDate: '2024-06-02T12:00:00',
    location: 'Surabaya',
    ...
    seatLeft: 400,
    category: 'Sports',
    organizer: { id: '5', name: 'City Run Org', email: 'info@cityrun.com' },
  ...
  },
  {
    ...
    endDate: '2024-03-18T23:00:00',
    location: 'Jakarta',
    address: 'Kuningan Arts Center, Jakarta Selatan',
    price: 200000,
    seatTotal: 80,
    seatLeft: 10,
    category: 'Music',
    organizer: { id: '6', name: 'Jazz Corner', email: 'bookings@jazzcorner.com' },
